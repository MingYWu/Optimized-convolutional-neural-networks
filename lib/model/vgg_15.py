...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=3,
        ...
        self.params['W6'] = weight_scale * cp.random.normal(loc=0, scale=(2 / (512 * 2 * 2)) ** 0.5, size=(2 * 2 * 512, 10))
    ...
    def loss(self, X, y=None):
        ...
        if y is not None:
            feature_4_4 = dropout_forward(feature_4_4, 0.6)

        scores, cache_6 = affine_forward(feature_4_4, W6, b6)
        ...
        dfeature_4_4 = max_pool_backward(dfeature_6, cache_4_4)
