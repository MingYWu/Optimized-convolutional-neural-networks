...
class ThreeLayerConvNet(object):
    """
        这是一个基于vgg编写的卷积神经网络，其中包含9层卷积层，和一个全脸全连接层。dropout选取的参数为0.5
    """
    ...
    def __init__(self, input_dim=(3, 32, 32), weight_scale=1, reg=0.0, dtype=cp.float32):
        ...
        self.params['W6'] = weight_scale * cp.random.normal(loc=0, scale=(2 / (512 * 2 * 2)) ** 0.5,
                                                            size=(2 * 2 * 512, 10))
    ...
    def loss(self, X, y=None):
        ...
        if y is not None:
            feature_5_1 = dropout_forward(feature_5_1, 0.5)

        scores, cache_6 = affine_forward(feature_5_1, W6, b6)
        ...
        grads = {'W1_1': dW1_1, 'b1_1': db1_1, 'W1_2': dW1_2, 'b1_2': db1_2,
                 ...
                 # 'W5_2': dW5_2, 'b5_2': db5_2,
                 'gamma5_1': dgamma5_1, 'beta5_1': dbeta5_1,
                 # 'gamma5_2': dgamma5_2, 'beta5_2': dbeta5_2,
