...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), weight_scale=1, reg=0.0, dtype=cp.float32):
        ...
        # 16 * 16
        self.params['W2_1'] = weight_scale * cp.random.normal(loc=0, scale=(2 / (64 * 16 * 16)) ** 0.5,
                                                              size=(128, 64, 3, 3))
        ...
        self.params['beta3_1'] = cp.zeros(16384)  # 存在独立的维度参数  (D,1)  # 8*8*256
        self.params['gamma3_1'] = cp.ones(16384)
        self.params['beta3_2'] = cp.zeros(16384)
        ...
        self.params['W6'] = weight_scale * cp.random.normal(loc=0, scale=(2 / (512 * 1 * 1)) ** 0.5,
                                                            size=(1 * 1 * 256, 10))
    ...
    def loss(self, X, y=None):
        ...
        if y is not None:
            feature_6_1 = dropout_forward(feature_6_1, 0.5)

        scores, cache_6 = affine_forward(feature_6_1, W6, b6)
        ...
        dfeature_5_3 = max_pool_backward(dfeature_6_1, cache_5_3)
        dfeature_5_2, dW5_2, db5_2, dgamma5_2, dbeta5_2 = conv_bn_relu_backward(dfeature_5_3, cache_5_2)
        ...
        dfeature_4_2, dW4_2, db4_2, dgamma4_2, dbeta4_2 = conv_bn_relu_backward(dfeature_4_3, cache_4_2)
