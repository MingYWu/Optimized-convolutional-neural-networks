...
#         self.params['W6_1'] = weight_scale * cp.random.normal(loc=0.0, scale=(2 / (512 * 1 * 1)) ** 0.5, size=(256, 512, 3, 3))
#         self.params['b6_1'] = cp.zeros(256)
#         self.params['W6'] = weight_scale * cp.random.normal(loc=0, scale=(2 / (512 * 1 * 1)) ** 0.5, size=(1 * 1 * 256, 10))
...
#         feature_4_1, cache_4_1 = conv_relu_forward(feature_3_3, W4_1, b4_1, conv_param)
...
#         feature_5_1, cache_5_1 = conv_relu_forward(feature_4_3, W5_1, b5_1, conv_param)
...
#         feature_6_1, cache_6_1 = conv_relu_forward(feature_5_3, W6_1, b6_1, conv_param)
#         if y is not None:
...
#         dfeature_6_1, dW6_1, db6_1 = conv_relu_backward(dfeature_6, cache_6_1)
...
#                  'W6_1': dW6_1, 'b6_1': db6_1, 'W6': dW6, 'b6': db6}
